...
class PlatformSettings(BaseModel):
    ...
    site_name = models.CharField(max_length=120, default="Enterprise Platform")
    site_tagline = models.CharField(max_length=255, blank=True, default="Classic software for modern enterprise teams")
    site_description = models.TextField(blank=True, default="Enterprise software platform for modern teams.")
    default_seo_title = models.CharField(max_length=120, blank=True, default="Enterprise Platform")
